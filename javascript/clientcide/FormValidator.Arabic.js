...
if (Date.$culture == "US") {
	try {
		console.log("WARNING: this validator (Arabic) is designed to use European style formatting, but Date.$culture is set to US. Consider changing this value to 'GB' for DD/MM/YYYY.")
	} catch(e){}
}